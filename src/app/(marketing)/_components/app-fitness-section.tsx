    ...
    >
      <div className="mx-auto max-w-[1440px] px-6 md:px-24">
        ...
        <div className="mt-12 grid lg:grid-cols-[324px_1fr] gap-10 items-center">
          ...
          {/* Features card */}
          <div className="bg-white rounded-[30px] p-8 md:p-10 shadow-[9px_6px_20px_rgba(0,0,0,0.12)]">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 lg:divide-x lg:divide-[#f2f2f2]">
              {FEATURES.map((feature) => (
                <div
                  key={feature.title}
                  className="flex flex-col items-center text-center px-2 first:pl-0 last:pr-0 lg:px-5"
                >
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                ...
                target="_blank"
                rel="noopener"
                className="inline-flex items-center gap-4 bg-black rounded-[10px] px-5 py-4 text-white w-full sm:w-[310px]"
              >
                <span className="text-3xl"></span>
                <span className="flex flex-col leading-tight">
                  <span className="text-sm">Compatible con dispositivos</span>
              ...
              <Link
                ...
                target="_blank"
                rel="noopener"
                className="inline-flex items-center gap-4 bg-black rounded-[10px] px-5 py-4 text-white w-full sm:w-[299px]"
              >
                <Image
