...
export function FigmaDesktopClone() {
    ...
    <section id="app" className="absolute left-[-10px] top-[1892px] h-[656px] w-[1440px]">
      ...
      <div className="absolute left-[70px] top-[203px] h-[348px] w-[324px] overflow-hidden">
        <img
          ...
          className="absolute left-[-37.28%] top-[-6.23%] h-[109.99%] w-[177.26%] max-w-none"
        />
      </div>
      ...
      <div className="absolute left-[375px] top-[213px] flex w-[970px] flex-col items-center justify-center gap-8 rounded-[30px] bg-white p-[30px] shadow-[9px_6px_8.5px_rgba(0,0,0,0.15)]">
        <div className="flex items-stretch gap-[19px]">
          {[0, 1, 2, 3].map((index) => (
            <div key={index} className="flex items-stretch gap-[19px]">
              <Feature index={index} />
...
function Feature({ index }: { index: number }) {
  ...
  return (
    <div className="flex w-[174px] flex-col items-center gap-3 rounded-[30px]">
      ...
      <p className="text-center text-[12px] leading-relaxed tracking-[0.12px] text-black">
        {feature.body}
      </p>
    </div>
  );
...
function Divider() {
  return <span className="h-[136px] w-px shrink-0 self-center bg-[#F2F2F2]" aria-hidden />;
}
  ...
  return (
    <article className="relative flex h-[243px] w-[250px] flex-col items-center justify-center gap-3 overflow-hidden rounded-[30px] p-[30px] shadow-[0_2px_8.5px_rgba(0,0,0,0.25)]">
      ...
      <img
        ...
        className="absolute left-[-1.7%] top-[29.15%] h-[70.85%] w-[103.3%] max-w-none"
      />
  ...
  return (
    <article className="flex h-[224px] gap-[23px] rounded-[30px] bg-white p-[30px] shadow-[0_2px_8.5px_rgba(0,0,0,0.25)]">
      <img
        ...
        decoding="async"
        src={challenge.image}
        className="h-[153px] w-[198px] shrink-0 object-cover"
      />
  ...
  return (
    <footer className="absolute left-0 top-[4890px] h-[72px] w-[1440px] bg-white">
      <img
        ...
        className="absolute left-1/2 top-0 h-[72px] w-[276px] -translate-x-1/2"
      />
...
function ImageCrop({
  ...
  return (
    <div className={`absolute overflow-hidden ${className}`}>
      <img alt="" loading="lazy" decoding="async" src={src} className={`absolute max-w-none ${imgClassName}`} />
    </div>
  );
}
